...
function Home() {
  ...
  return (
    <>
      ...
      <div className="container mx-auto">
        {allNotes.length > 0 ? (
          ...
          <EmptyCard
            ...
            message={
              isSearch
                ? `Oops! No notes found for matching your search.`
      ...
      <button
        className="w-16 h-16 flex items-center justify-center rounded-2xl btn-primary hover:bg-blue-600 absolute right-10 bottom-10"
        onClick={() => {
          setOpenAddEditModal({
            isShow: true,
            type: "add",
